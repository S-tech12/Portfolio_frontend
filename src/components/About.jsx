                ...
                <div className="col-sm-6">
                    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="card">
                        <div className="card-body">
                            ...
                            <a href="/assets/Result.pdf" download="Result.pdf" target="_blank" rel="noreferrer" className="btn btn-primary" id="DownloadButton"><i className="bi bi-filetype-pdf"></i> Download Academic Result</a>
                        </div>
                    </motion.div>
                </div>
                <div className="col-sm-6">
